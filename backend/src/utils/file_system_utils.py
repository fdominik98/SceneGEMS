...
TRAJECTORY_GENERATION_RUNTIME_FOLDER = f"{RUNTIME_ASSETS_FOLDER}/trajectory_generation"
TRAJECTORY_GENERATION_GEN_FOLDER = f"{TRAJECTORY_GENERATION_RUNTIME_FOLDER}/gen_tmp"
    ...
    if runtime_assets_writable:
        folders.extend(
            [
                ...
                TRAJECTORY_GENERATION_RUNTIME_FOLDER,
                MONITORING_GEN_FOLDER,
                SCENARIO_GENERATION_GEN_FOLDER,
                TRAJECTORY_GENERATION_GEN_FOLDER,
