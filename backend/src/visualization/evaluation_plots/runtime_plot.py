...
from utils.evaluation_config import DC_RS, DC_SB_II, MSR_CDRS, MSR_SB_II, MSR_SB_III, MSR_CDRS_PS, DC_SB_III
...
class RuntimePlot(EvalPlot):
    ...
    def config_groups(self) -> List[str]:
        ...
        return [DC_SB_II, DC_SB_III, DC_RS, MSR_SB_II, MSR_SB_III, MSR_CDRS, MSR_CDRS_PS]
