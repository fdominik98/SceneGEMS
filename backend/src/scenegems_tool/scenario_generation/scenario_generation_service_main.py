...
from scenegems_tool.waraps_integration.mqtt_scenario_generation_service import MqttScenarioGenerationService
...
def main() -> None:
    ...
    service = MqttScenarioGenerationService(mqtt_connection, reference_geofence)
    service.connect()
